...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    PortToChannel_channel(_this) {
      ...
      t2 = t1._eval$1("@(Stream.T)")._as(new A.PortToChannel_channel_closure());
      t3 = controller.__StreamChannelController__local_F;
      t3 === $ && A.throwLateFieldNI("_local");
      t4 = t3.__GuaranteeChannel__sink_F;
      t4 === $ && A.throwLateFieldNI("_sink");
      new A._MapStream(t2, new A._EventStream(_this, "message", false, t1), t1._eval$1("_MapStream<Stream.T,@>")).pipe$1(t4);
      t3 = t3.__GuaranteeChannel__streamController_F;
      t3 === $ && A.throwLateFieldNI("_streamController");
      new A._ControllerStream(t3, A._instanceType(t3)._eval$1("_ControllerStream<1>")).listen$2$onDone(B.MessagePort_methods.get$postMessage(_this), B.MessagePort_methods.get$close(_this));
    ...
    _replaceDartBigInts(dartList) {
      var t2, t3, t4, _i, arg, t1 = [];
      for (t2 = dartList.length, t3 = type$.BigInt, t4 = type$._BigIntImpl, _i = 0; _i < dartList.length; dartList.length === t2 || (0, A.throwConcurrentModificationError)(dartList), ++_i) {
        arg = dartList[_i];
        if (t3._is(arg)) {
          if (arg.compareTo$1(0, t4._as($.$get$_BigIntRangeCheck__bigIntMinValue64())) < 0 || arg.compareTo$1(0, t4._as($.$get$_BigIntRangeCheck__bigIntMaxValue64())) > 0)
  ...
  A.ListBase.prototype = {
    ...
    sublist$2(receiver, start, end) {
      ...
      return A.List_List$from(this.getRange$2(receiver, start, end), A.instanceType(receiver)._eval$1("ListBase.E"));
    },
    getRange$2(receiver, start, end) {
  ...
  A.DriftCommunication_closure.prototype = {
    call$0() {
      var t1, t2, t3, t4, t5;
      for (t1 = this.$this, t2 = t1._pendingRequests, t3 = t2.get$values(t2), t4 = A._instanceType(t3), t4 = t4._eval$1("@<1>")._bind$1(t4._rest[1]), t3 = new A.MappedIterator(J.get$iterator$ax(t3.__internal$_iterable), t3._f, t4._eval$1("MappedIterator<1,2>")), t4 = t4._rest[1]; t3.moveNext$0();) {
        t5 = t3.__internal$_current;
        if (t5 == null)
          t5 = t4._as(t5);
        t5.completer.completeError$2(B.C_ConnectionClosedException, t5.requestTrace);
      }
      t2.clear$0(0);
  ...
  A.DriftCommunication_setRequestHandler_closure.prototype = {
    ...
    $call$body$DriftCommunication_setRequestHandler_closure(request) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$returnValue, $async$handler = 2, $async$currentError, $async$self = this, e, s, exception, t1, t2, response, $async$exception;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$handler = 4;
              $async$goto = 7;
              return A._asyncAwait($async$self.handler.call$1(request), $async$call$1);
            case 7:
              // returning from await.
  ...
  A.DriftProtocol.prototype = {
    ...
    decodePayload$1(encoded) {
      ...
      switch (tag) {
        ...
        case 13:
          t1.toString;
          return new A.ServerInfo(A.EnumByName_byName(B.List_ww8, A._asString(J.$index$asx(t1, 1)), type$.SqlDialect));
        case 7:
    ...
    _encodeDbValue$1(variable) {
      ...
      else if (type$.BigInt._is(variable))
  ...
  A._StatementBasedTransactionExecutor.prototype = {
    ...
    beginTransaction$0() {
      ...
      t1 = "" + ownDepth;
      return new A._StatementBasedTransactionExecutor(_this._engines$_delegate, new A._AsyncCompleter(new A._Future($.Zone__current, type$._Future_void), type$._AsyncCompleter_void), _this, "SAVEPOINT s" + t1, "RELEASE s" + t1, "ROLLBACK TO s" + t1, _this._db, new A.Lock());
    },
    send$0(_) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
  ...
  A._WebDelegate.prototype = {
    ...
    runBatched$1(statements) {
      ...
      for (t2 = statements.statements, t3 = t2.$ti, t2 = new A.ListIterator(t2, t2.get$length(t2), t3._eval$1("ListIterator<ListBase.E>")), t3 = t3._eval$1("ListBase.E"); t2.moveNext$0();) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t2.free$0(t1);
              $async$goto = A.stringContainsUnchecked(statement, "RETURNING", 0) ? 3 : 4;
              break;
            case 3:
              // then
              $async$goto = 5;
  ...
  A._RunningDriftWorker__newConnection_remainingChannel.prototype = {
    call$0() {
      var t1 = this.originalChannel,
        t2 = t1.$ti,
        t3 = t2._eval$1("Stream<1>(Stream<1>)")._as(new A._RunningDriftWorker__newConnection_remainingChannel_closure(this._box_0)).call$1(t1.get$stream(t1)),
  ...
  (function installTearOffs() {
    ...
    _static(A, "async___rootHandleUncaughtError$closure", 5, null, ["call$5"], ["_rootHandleUncaughtError"], 61, 0);
    ...
    _static(A, "async___rootErrorCallback$closure", 5, null, ["call$5"], ["_rootErrorCallback"], 68, 0);
    _static(A, "async___rootScheduleMicrotask$closure", 4, null, ["call$4"], ["_rootScheduleMicrotask"], 69, 0);
    _static(A, "async___rootCreateTimer$closure", 5, null, ["call$5"], ["_rootCreateTimer"], 70, 0);
    _static(A, "async___rootCreatePeriodicTimer$closure", 5, null, ["call$5"], ["_rootCreatePeriodicTimer"], 71, 0);
    _static(A, "async___rootPrint$closure", 4, null, ["call$4"], ["_rootPrint"], 72, 0);
    _static_1(A, "async___printToZone$closure", "_printToZone", 73);
    ...
    _instance(A._Completer.prototype, "get$completeError", 0, 1, null, ["call$2", "call$1"], ["completeError$2", "completeError$1"], 7, 0, 0);
    ...
    _instance(_, "get$addError", 0, 1, function() {
      return [null];
    }, ["call$2", "call$1"], ["addError$2", "addError$1"], 7, 0, 0);
    _instance_0_u(_ = A._ControllerSubscription.prototype, "get$_onPause", "_onPause$0", 0);
    _instance_0_u(_, "get$_onResume", "_onResume$0", 0);
    _instance_1_i(A._StreamSinkWrapper.prototype, "get$add", "add$1", 2);
    ...
    _instance(_, "get$postMessage", 1, 1, function() {
      return [null];
    }, ["call$2", "call$1"], ["postMessage$2", "postMessage$1"], 31, 0, 0);
    _static_1(A, "js___convertToDart$closure", "_convertToDart", 75);
    _instance_1_u(A.DriftCommunication.prototype, "get$_communication$_handleMessage", "_communication$_handleMessage$1", 2);
    _instance_1_u(A.DriftProtocol.prototype, "get$_decodeDbValue", "_decodeDbValue$1", 41);
    _static_1(A, "sql_js_SqlJsModule_____tearOff$closure", "SqlJsModule_____tearOff", 50);
    _instance_1_u(_ = A._RunningDriftWorker.prototype, "get$_newConnection", "_newConnection$1", 56);
    _instance_1_u(_, "get$_handleMessage", "_handleMessage$1", 2);
    _instance(A._GuaranteeSink.prototype, "get$_guarantee_channel$_addError", 0, 1, function() {
      return [null];
    }, ["call$2", "call$1"], ["_guarantee_channel$_addError$2", "_guarantee_channel$_addError$1"], 7, 0, 0);
  })();
...
;
    ...
    B.SqlDialect_0 = new A.SqlDialect(0, "sqlite");
    B.SqlDialect_1 = new A.SqlDialect(1, "mysql");
    B.SqlDialect_2 = new A.SqlDialect(2, "postgres");
    B.List_ww8 = A._setArrayType(makeConstList([B.SqlDialect_0, B.SqlDialect_1, B.SqlDialect_2]), A.findType("JSArray<SqlDialect>"));
