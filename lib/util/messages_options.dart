...
class MessagesOptions {
  ...
  static MessagesOptions of(BuildContext context) {
    final scope =
        context.dependOnInheritedWidgetOfExactType<_ModelBindingScope>()!;
    return scope.modelBindingState.currentModel;
  }

  static void update(BuildContext context, MessagesOptions newModel) {
    final scope =
        context.dependOnInheritedWidgetOfExactType<_ModelBindingScope>()!;
...
// Applies text MessagesOptions to a widget
class ApplyTextOptions extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final options = MessagesOptions.of(context);
...
class ModelBinding extends StatefulWidget {
  ...
  final MessagesOptions initialModel;
  final Widget child;
...
class _ModelBindingState extends State<ModelBinding> {
  late MessagesOptions currentModel;
  ...
  void handleTimeDilation(MessagesOptions newModel) {
  ...
  void updateModel(MessagesOptions newModel) {
