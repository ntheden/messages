...
import 'messages_localizations_en.dart' deferred as messages_localizations_en;
// The rest of the localizations go here...

/// Callers can lookup localized strings with an instance of MessagesLocalizations
/// returned by `MessagesLocalizations.of(context)`.
///
/// Applications need to include `MessagesLocalizations.delegate()` in their app's
/// `localizationDelegates` list, and the locales they support in the app's
/// `supportedLocales` list. For example:
///
/// ```dart
/// import 'gen_l10n/messages_localizations.dart';
///
/// return MaterialApp(
...
/// be consistent with the languages listed in the MessagesLocalizations.supportedLocales
/// property.
abstract class MessagesLocalizations {
  MessagesLocalizations(String locale) : localeName = intl.Intl.canonicalizedLocale(locale.toString());

  final String localeName;

  static MessagesLocalizations? of(BuildContext context) {
    return Localizations.of<MessagesLocalizations>(context, MessagesLocalizations);
  }

  static const LocalizationsDelegate<MessagesLocalizations> delegate = _MessagesLocalizationsDelegate();
  ...
  /// Header title on home screen for Messages section.
  ///
  /// In en, this message translates to:
  /// **'Messages'**
  String get homeHeaderMessages;
  ...
  /// Tip for user, visible on the right side of the splash screen when Messages runs on a foldable device.
  ///
  /// In en, this message translates to:
  /// **'Select a demo'**
...
class _MessagesLocalizationsDelegate extends LocalizationsDelegate<MessagesLocalizations> {
  const _MessagesLocalizationsDelegate();

  @override
  Future<MessagesLocalizations> load(Locale locale) {
    return lookupMessagesLocalizations(locale);
  }
  ...
  @override
  bool shouldReload(_MessagesLocalizationsDelegate old) => false;
}

Future<MessagesLocalizations> lookupMessagesLocalizations(Locale locale) {

  // Lookup logic when language+country codes are specified.
  switch (locale.languageCode) {
    case 'en': {
  switch (locale.countryCode) {
    case 'AU': return messages_localizations_en.loadLibrary().then((dynamic _) => messages_localizations_en.MessagesLocalizationsEnAu());
case 'CA': return messages_localizations_en.loadLibrary().then((dynamic _) => messages_localizations_en.MessagesLocalizationsEnCa());
case 'GB': return messages_localizations_en.loadLibrary().then((dynamic _) => messages_localizations_en.MessagesLocalizationsEnGb());
case 'IE': return messages_localizations_en.loadLibrary().then((dynamic _) => messages_localizations_en.MessagesLocalizationsEnIe());
case 'IN': return messages_localizations_en.loadLibrary().then((dynamic _) => messages_localizations_en.MessagesLocalizationsEnIn());
case 'NZ': return messages_localizations_en.loadLibrary().then((dynamic _) => messages_localizations_en.MessagesLocalizationsEnNz());
case 'SG': return messages_localizations_en.loadLibrary().then((dynamic _) => messages_localizations_en.MessagesLocalizationsEnSg());
case 'ZA': return messages_localizations_en.loadLibrary().then((dynamic _) => messages_localizations_en.MessagesLocalizationsEnZa());
   }
  break;
   }
  }
  ...
  switch (locale.languageCode) {
    case 'en': return messages_localizations_en.loadLibrary().then((dynamic _) => messages_localizations_en.MessagesLocalizationsEn());
  }

  throw FlutterError(
    'MessagesLocalizations.delegate failed to load unsupported locale "$locale". This is likely '
